...
declare_id!("AWhtudEGK1zToPqRmp8FRC6Jv2riRCA973PTPMfjWLqF");

/// ============================================================================
/// LP BONDS - LEVEL 1 LOCKER PROGRAM
/// ============================================================================
///
/// This program handles Level 1 LP Bond creation and redemption:
...
pub mod lp_bonds {
    ...
    pub fn add_liquidity_and_mint_bond(
        ...
        // Parse and validate whirlpool data
        let whirlpool = Whirlpool::from_account_info(&ctx.accounts.whirlpool.to_account_info())?;
        ...
        // STEP 3: Create custody position token account
        ...
        // STEP 5: Transfer position NFT to custody
        token::transfer(
            CpiContext::new(
                ctx.accounts.token_program.to_account_info(),
                Transfer {
        ...
        // STEP 8: Initialize position custody
        ...
        custody.level = 1;
        custody.lock_duration = DEFAULT_LEVEL_1_LOCK_DURATION;
        ...
        // STEP 9: Close temporary wSOL account
        ...
        emit!(BondMinted {
            ...
            level: 1,
            lock_duration: DEFAULT_LEVEL_1_LOCK_DURATION,
    ...
    /// Checks timelock before allowing redemption.
...
pub struct AddLiquidityAndMintBond<'info> {
    ...
    #[account(address = NATIVE_MINT @ LpBondsError::InvalidNativeMint)]
    pub wsol_mint: Box<Account<'info, Mint>>,

    #[account(address = EXPECTED_TOKEN_MINT_B @ LpBondsError::InvalidTokenMintB)]
    ...
    /// CHECK: Validated against whirlpool data
    #[account(mut)]
